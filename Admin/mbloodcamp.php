...
<div class="wrapper">
  <div class="header">
	...
	<center>
	  <?php
			echo "<table><tr><th style=\"padding:15px\">Name</th><th>Address</th><th>City</th><th>Date</th><th>Time</th><th></th><th></th></tr>";
			...
			while($line=mysqli_fetch_array($result))
			{
				...
				echo "<td>";
				$id=$line['cid'];
				echo "<a href=\"updatebc.php?id=$id\">Edit</a>";
				echo "</td>";
				$id=$line['cid'];
				echo "<td>";
				echo "<a href=\"deletebc.php?did=$id\">Delete</a>";
				echo "</td>";
				echo "</tr>";
			}
				echo "</table>";
