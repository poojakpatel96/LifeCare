    ...
    <div class="service-box">
      <div class="row service">
        <div class="columns large-4">
          <div class="box">
            <p><a href="cbloodgroup.php"><img src="images/bloodgroup.jpg" alt="" class="service-img"></a></p>
            <h1><a href="cbloodgroup.php"><center>Blood Group</center></a></h1>
          </div>
        </div>
         <div class="columns large-4">
          <div class="box">
            <p><a href="cbloodcamp.php"><img src="images/bloodcamp.png" alt="" class="service-img"></a></p>
            <h1><a href="cbloodcamp.php"><center>Blood Camp</center></a></h1>
          </div>
        </div>
         <div class="columns large-4">
          <div class="box">
            <p><a href="crequest.php"><img src="images/bloodrequest2.jpg" alt="" class="service-img"></a></p>
            <h1><a href="crequest.php"><center>Raise a Request</center></a></h1>
          </div>
        </div>
      </div>
    </div>
	 <div class="service-box">
      <div class="row service">
	    <div class="columns large-4">
          <div class="box">
            <p><a href="cdonor.php"><img src="images/donor2.png" alt="" class="service-img"></a></p>
            <h1><a href="cdonor.php"><center>Donor</center></a></h1>
          </div>
        </div>
        <div class="columns large-4">
          <div class="box">
            <p><a href="cpatient.php"><img src="images/patient4.jpg" alt="" class="service-img"></a></p>
            <h1><a href="cpatient.php"><center>Patient</center></a></h1>
          </div>
        </div>
         <div class="columns large-4">
          <div class="box">
            <p><a href="chospital.php"><img src="images/hospital3.png" alt="" class="service-img"></a></p>
            <h1><a href="chospital.php"><center>Hospital</center></a></h1>
          </div>
        </div>
		 <div class="columns large-4">
          <div class="box">
            <p><a href="cdonation.php"><img src="images/donation.jpg" alt="" class="service-img"></a></p>
            <h1><a href="cdonation.php"><center>Donation</center></a></h1>
          </div>
        </div>
		<div class="columns large-4">
          <div class="box">
            <p><a href="cadmin.php"><img src="images/admin.png" alt="" class="service-img"></a></p>
            <h1><a href="cadmin.php"><center>Administrator</center></a></h1>
          </div>
        </div>
		<div class="columns large-4">
          <div class="box">
            <p><a href="ccity.php"><img src="images/city.png" alt="" class="service-img"></a></p>
            <h1><a href="ccity.php"><center>City</center></a></h1>
          </div>
        </div>
      </div>
    </div>
