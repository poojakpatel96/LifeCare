		...
		<br>
			...
			<table>
				<tr>
					<td>City Name</td>
					<td>:</td>
					<td><input type="text" name="txtct" required/></td>
			...
			<?php
				if(isset($_POST['btnsubmit']))
				{
					...
					if(empty($ct))
					{
						echo "<h4 style=\"color:red\">Please insert city name first!</h4>";
					}
					$flag=0;
					...
					while($line=mysqli_fetch_array($result))
						{
							if($line['name']==$ct)
							{
							   echo "<h4 style=\"color:red\">This city already exists!</h4>";
							   $flag=1;
							}
						}
					...
					if($flag==0)
					{
						...
						$sql="insert into `tblcity` values(NULL,'$ct')";
							if(mysqli_query($con,$sql))
							{
							echo "<h4 style=\"color:green\">City inserted !</h4>";
							}
							else
							{
