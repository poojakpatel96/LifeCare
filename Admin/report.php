    ...
    <div class="service-box">
      <div class="row service">
        <div class="columns large-4">
          <div class="box">
            <p><a href="rbloodgroup.php"><img src="images/bloodgroup.jpg" alt="" class="service-img"></a></p>
            <h1><a href="rbloodgroup.php"><center>Blood Group</center></a></h1>
          </div>
        </div>
         <div class="columns large-4">
          <div class="box">
            <p><a href="rbloodcamp.php"><img src="images/bloodcamp.png" alt="" class="service-img"></a></p>
            <h1><a href="rbloodcamp.php"><center>Blood Camp</center></a></h1>
          </div>
        </div>
          <div class="columns large-4">
          <div class="box">
            <p><a href="rbloodstock.php"><img src="images/donation.jpg" alt="" class="service-img"></a></p>
            <h1><a href="rbloodstock.php"><center>Blood Stock</center></a></h1>
          </div>
        </div>
      </div>
    </div>
	 <div class="service-box">
      <div class="row service">
	    <div class="columns large-4">
          <div class="box">
            <p><a href="rdonor.php"><img src="images/donor2.png" alt="" class="service-img"></a></p>
            <h1><a href="rdonor.php"><center>Donor</center></a></h1>
          </div>
        </div>
        <div class="columns large-4">
          <div class="box">
            <p><a href="rpatient.php"><img src="images/patient4.jpg" alt="" class="service-img"></a></p>
            <h1><a href="rpatient.php"><center>Patient</center></a></h1>
          </div>
        </div>
         <div class="columns large-4">
          <div class="box">
            <p><a href="rhospital.php"><img src="images/hospital3.png" alt="" class="service-img"></a></p>
            <h1><a href="rhospital.php"><center>Hospital</center></a></h1>
          </div>
        </div>
