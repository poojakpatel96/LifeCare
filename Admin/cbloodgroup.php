...
<div class="wrapper">
  <div class="header">
	...
	<div style="margin-left:45px; min-height: 500px">
		<br>
			<h1>Create New Blood Group:</h1>
			<form name="form1" method="POST" action="">
			<table>
				<tr>
					<td>Blood Group Name</td>
					<td>:</td>
					<td><input type="text" name="txtbg" id="txtbg" value="<?php if(isset($_POST['txtbg'])) echo $_POST['txtbg']; ?>"/></td>
					<td style="width:650px"></td>
				</tr>
				<tr>
					<td></td>
					<td></td>
					<td><input type="submit" name="btnsubmit" id="btnsubmit" value="INSERT"  /></td>
					<td style="width:650px"></td>
				</tr>
			</table>
			</form>
			...
			function funname()
			{
				var a=document.getElementById('txtbg');
				if(a.value=="")
				{
			...
			<?php
				if(isset($_POST['btnsubmit']))
				{
					...
					if(empty($gn))
					{
						...
						echo "<h4 style=\"color:red\">Please Insert Group name first!</h4>";
						$flag=1;
					}
					else
					{
						...
						while($line=mysqli_fetch_array($result))
							{
								if($line['groupname']==$gn)
								{
								   echo "<h4 style=\"color:red\">This blood group already exists!</h4>";
								   $flag=1;
								}
							}
					}
					if($flag==0)
					{
						...
						$sql="insert into `tblbloodgroup` values(NULL,'$gn','$aid','$d')";
