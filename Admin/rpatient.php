  ...
  <div class="header">
	...
	<input type="submit" value="Search" name="btnsubmit" id="btnsubmit"/>
	  ...
	  if(isset($_POST['btnsubmit']))
	  {
			...
			$sql="Select * from tblpatient,tblcity,tblbloodgroup where tblpatient.cityid=tblcity.cityid and tblpatient.bloodgrp=tblbloodgroup.bgid and tblpatient.fullname like '$nm%'";
