...
<div class="wrapper">
  <div class="header">
	...
	<input type="submit" value="Search" name="btnsubmit" id="btnsubmit"/>
	  ...
	  {
			$nm=$_POST['txtnm'];
			echo "<table id=\"table1\"><tr><th style=\"padding:15px\">Name</th><th>Username</th><th>Email</th><th>Phone Number</th><th>City</th></tr>";
			$sql="Select * from tblhospital,tblcity where tblhospital.cityid=tblcity.cityid and tblhospital.hname like '$nm%'";
