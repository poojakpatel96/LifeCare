...
<div class="wrapper">
  <div class="header">
	...
	?>
	<div>
	<center><h3>Manage</h3></center>
	</div>
    <div class="service-box">
      <div class="row service">
        <div class="columns large-4">
          <div class="box">
            <p><a href="mbloodgroup.php"><img src="images/bloodgroup.jpg" alt="" class="service-img"></a></p>
            <h1><a href="mbloodgroup.php"><center>Blood Group</center></a></h1>
          </div>
        </div>
         <div class="columns large-4">
          <div class="box">
            <p><a href="mbloodcamp.php"><img src="images/bloodcamp.png" alt="" class="service-img"></a></p>
            <h1><a href="mbloodcamp.php"><center>Blood Camp</center></a></h1>
          </div>
        </div>
         <div class="columns large-4">
          <div class="box">
            <p><a href="mbloodstock.php"><img src="images/donation.jpg" alt="" class="service-img"></a></p>
            <h1><a href="mbloodstock.php"><center>Blood Stock</center></a></h1>
          </div>
        </div>
      </div>
    </div>
	 <div class="service-box">
      <div class="row service">
	    <div class="columns large-4">
          <div class="box">
            <p><a href="mbloodrequest.php"><img src="images/bloodrequest2.jpg" alt="" class="service-img"></a></p>
            <h1><a href="mbloodrequest.php"><center>Blood Request</center></a></h1>
          </div>
        </div>
        <div class="columns large-4">
          <div class="box">
