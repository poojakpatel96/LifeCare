...
<div class="wrapper">
  <div class="header">
	...
	<center>
	  <?php
			echo "<table><tr><th style=\"padding:15px\">GroupName</th><th>Units</th><th></th></tr>";
			$sql="Select * from tblbloodstock,tblbloodgroup where tblbloodgroup.bgid=tblbloodstock.bgid";
