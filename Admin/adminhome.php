...
<div class="wrapper">
  <div class="header">
	...
	if(isset($_SESSION['admin']))
	{
		...
		$aid=$_SESSION['admin'];
		$sql="Select * from tbladmin where adminid=$aid";
		$result=mysqli_query($con,$sql);
		$line=mysqli_fetch_array($result);
		echo "<h1>Welcome, ",$line['fullname'],"</h1>";
	}
	else
	{
		header("Location:adminlogin.php");
          ...
          <div class="row flexslider-row">
            <div class="columns large-12">
              <div class="flexslider">
                <ul class="slides" color:black">
				  <li><p style="font-size:30px">"Share a little, care a little – Donate Blood."</p><img src="images/slider121.jpg" alt="" ></li>
                  <li><p style="font-size:30px">"A Life May Depend On A Gesture From You, A Bottle Of Blood."</p><img src="images/slider13.jpg" alt="" ></li>
                  <li><p style="font-size:30px">"The Finest Gesture One Can Make Is To Save Life By Donating Blood."</p><img src="images/slider15.jpg" alt="" ></li>
                  <li><p style="font-size:30px">"Blood Donation Will Cost You Nothing But It Will Save A Life!"</p><img src="images/slider17.jpg" alt="" ></li>
                </ul>
              </div>
            </div>
          </div>
