...
<div class="wrapper">
  <div class="header">
	...
	<div>
	<br>
	<center><h3>Blood Camps</h3></center>
	</div>
	...
	<td> : </td>
	<td><input type="text" name="txtcm" id="txtcm" value="" /></td>
	</tr>
	<tr>
	<td></td>
	<td></td>
	...
	<input type="submit" value="Search" name="btnsubmit" id="btnsubmit"/>
	  ...
	  {
			$cm=$_POST['txtcm'];
			echo "<table id=\"table1\"><tr><th style=\"padding:15px;\">Name</th><th>Address</th><th>City</th><th>Image</th><th>Time</th></tr>";
			$sql="Select * from tblbloodcamp,tblcity where tblbloodcamp.cityid=tblcity.cityid and tblbloodcamp.nameofcamp like '$cm%'";
