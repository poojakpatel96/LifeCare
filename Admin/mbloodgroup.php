...
<div class="wrapper">
  <div class="header">
	...
	<div>
	<br>
	<center><h3>Blood Groups</h3></center>
	</div>
	<div  style="min-height:500px;margin-left:100px;margin-right:100px">
	<center>
	  <?php
			echo "<table style=\"width:100%\"><tr><th style=\"padding:15px\">GroupName</th><th>Date</th><th>Created by </th><th></th><th></th></tr>";
			$sql="Select * from tblbloodgroup,tbladmin where tbladmin.adminid=tblbloodgroup.adminid";
			...
			while($line=mysqli_fetch_array($result))
			{
				...
				$id=$line['bgid'];
				echo "<td>";
				echo "<a href=\"updatebg.php?id=$id\">Edit</a>";
				echo "</td>";
				$id=$line['bgid'];
				echo "<td>";
				echo "<a href=\"deletebg.php?did=$id\">Delete</a>";
				echo "</td>";
				echo "</tr>";
			}
				echo "</table>";
