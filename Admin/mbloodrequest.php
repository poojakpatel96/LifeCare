...
<div class="wrapper">
  <div class="header">
	...
	<center>
	  <?php
			echo "<table><tr><th style=\"padding:15px\">Patient Name</th><th>Blood Group</th><th>Units</th><th>Date</th><th></th></tr>";
			$sql="Select * from tblbloodreq,tblpatient,tblbloodgroup where tblbloodreq.rstatus=0 and tblpatient.patientid=tblbloodreq.rpatientid and tblbloodgroup.bgid=tblbloodreq.bgid";
			...
			while($line=mysqli_fetch_array($result))
			{
				...
				echo "<td>";
				$id=$line['rid'];
				echo "<a href=\"acceptreq.php?id=$id\">Accept</a>";
				echo "</td>";
				echo "</tr>";
			}
				echo "</table>";
